...
\hypersetup{breaklinks=true,
           bookmarks=true,
           pdfauthor={},
           pdftitle={Neutral ISM, Lyman-Alpha and Lyman-continuum in the nearby starburst Haro 11},
           colorlinks=true,
           citecolor=blue,
           urlcolor=blue,
           linkcolor=magenta,
...
\begin{figure*}
\centering
\subfloat[LIS\label{coldenLIS}]{\includegraphics[width=0.400\hsize]{./Fc_haro11c_LIS.pdf}}
\subfloat[\ion{Si}{4}\label{coldenHIS}]{\includegraphics[width=0.400\hsize]{./Fc_haro11c-SiIV.pdf}}
...
interesting to note the close similarity in shape between the \ion{Si}{2} and
\ion{Si}{4} line profiles, indicating that they likely represent two different
...
\ion{Si}{4} absorption here and, by extension, also the neutral medium. Looking
...
this work. We note that \ion{Na}{1} has a very low ionization potential of only
...
part transparent to LyC radiation and undetected in \ion{Si}{2}.
...
near unity of \ion{H}{1} from Lyman $\beta$ absorption, indicating column
