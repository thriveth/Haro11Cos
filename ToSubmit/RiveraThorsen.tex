...
defined from nebular emission from the \ion{H}{2} regions surrounding
...
$v \sim v_0$, Lyman continuum is sensitive to \ion{H}{1} at \emph{all}
...
Continuum radiation and undetected in \ion{Si}{2}.
